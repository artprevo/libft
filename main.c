...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/09 16:12:27 by artprevo          #+#    #+#             */
/*   Updated: 2018/11/09 17:23:17 by artprevo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	//ft_strncat//
	ft_putendl(YEL "\nft_strncat" RESET);
	if (ft_strcmp(ft_strncat(str7, "ca va"), strncat(str8, "ca va")) != 0)
		ft_putendl(RED "error test1 :(");
	else
		ft_putendl(GRN "test1 ok :)" RESET);
	ft_strclr(str7);
	ft_strclr(str8);
	if (ft_strncmp(ft_strcat(str7, "qwertyuio"), strcat(str8, "qwertyuio")) != 0)
		ft_putendl(RED "error test2 :(" RESET);
	else
		ft_putendl(GRN "test2 ok :)" RESET);
